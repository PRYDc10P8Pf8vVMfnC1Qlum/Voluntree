...
└── voluntree/
    ...
    └── website/
        ...
        ├── static/
        │   ├── img/
        │   │   ├── -icon-calendar copy.svg
        │   │   ├── -icon-calendar.svg
        │   │   ├── -icon-location-pin copy.svg
        ...
        │   │   ├── facebook.png
        │   │   ├── facebook.webp
        │   │   ├── facebook1mediafacebooksocial.svg
        │   │   ├── global.png
        │   │   ├── Hordiy.jpg
        │   │   ├── image-12@2x.png
        │   │   ├── instagram-1.svg
        ...
        │   │   ├── location.png
        │   │   ├── location.webp
        │   │   ├── locationpin3navigationmapmapspingpslocation.svg
        │   │   ├── logo_bright.png
        │   │   ├── logo_dark.png
        │   │   ├── mapfoldnavigationmapmapsgpstravelfold.svg
        │   │   ├── minimizewindow2expandretractshrinkbiggerbigsmallsmaller.svg
        │   │   ├── oport1.avif
        │   │   ├── oport2.avif
        │   │   ├── oport3.avif
        │   │   ├── organisation.webp
        ...
        │   │   ├── tree.jpg
        │   │   ├── twitter.jpeg
        │   │   ├── twittermediatwittersocial-1.svg
        │   │   ├── twittermediatwittersocial.svg
        │   │   ├── user.png
        │   │   ├── volun (1).png
        │   │   ├── volun (2).png
        │   │   ├── volunteer.png
        ...
        │   │   ├── script.js
        │   │   ├── script_choose.js
        │   │   ├── script_organization copy.js
        │   │   ├── script_organization.js
        │   │   ├── script_volunteer copy.js
        │   │   └── script_volunteer.js
        │   └── styles/
        │       ├── card.css
        │       ├── style.css
        │       ├── style_activity.css
        │       ├── style_choose.css
        │       ├── style_create_event.css
        │       ├── style_error.css
        │       ├── style_filter.css
        │       ├── style_organization.css
        │       ├── style_success.css
        │       ├── style_user.css
        │       └── style_volunteer.css
        ├── templates/
